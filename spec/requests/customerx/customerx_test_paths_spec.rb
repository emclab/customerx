...
describe "TestPaths" do
  describe "GET /customerx_test_paths" do
    before(:each) do
      ...
      ua15 = FactoryGirl.create(:sys_action_on_table, :table_name => 'customerx_comm_record_logs', :action => 'create' )
      ua16 = FactoryGirl.create(:sys_action_on_table, :table_name => 'customerx_lead_logs', :action => 'create' )
      ...
      @cust = FactoryGirl.create(:customer, :zone_id => z.id, :sales_id => u.id, :last_updated_by_id => u.id, :quality_system_id => qs.id)
